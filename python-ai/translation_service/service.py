...
class VoiceRequest(BaseModel):
    text: str
    language: str  # English, Arabic, French, etc.

ELEVENLABS_API_KEY = "sk_a22ee6f3715cb94a63acdf1f552110d3c320cc6e5adea549"

# Voice IDs that support non-English languages (or fallback to gTTS if not available)
ELEVENLABS_VOICES = {
    "english": "21m00Tcm4TlvDq8ikWAM",
    "french": None,  # None => use gTTS
    "german": None,
    "arabic": None,
    "spanish": None,
}
